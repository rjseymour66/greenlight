...
// GetAll method which returns a slice of movies. Although we're not
...
func (m MovieModel) GetAll(title string, genres []string, filters Filters) ([]*Movie, Metadata, error) {
	...
	// collect the values for the placeholders in a slice. Notice here
	// how we call the limit() and offset() methods on the Filters struct
	// to get the appropriate values for the LIMIT and OFFSET clauses.
